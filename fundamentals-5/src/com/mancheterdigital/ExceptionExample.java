...
public class ExceptionExample {
    ...
    public static void main(String[] args) {
        ...
        //easily fix using a try and a catch. Trps the error in the context of the code block

        /* try {
            //try to access element 3: Can add all the others in as well but cop out as error could be form multiple places
            printArray(3, intArray);
        }
        // put the type of expection you might recieve. Can tell from earlier error. ArrayIndexOutOfBoundsException
