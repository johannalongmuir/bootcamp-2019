...
public class VariableExample {
        ...
        public VariableExample(String author) { // constuctor, can make
            this.author = author;
        }
     ...
     */
        ...
        public static void main(String[] args) {
            ...
            VariableExample newScratch = new VariableExample(firstName); // is an instance. newScratch is the reference to it
